...
<body>
    ...
    <div class="page-wrapper">
        ...
        $MainTitle = 'Sanggavai\'s Raajam Garden';
        ?>
        ...
        <div class="image-wrap">
            <div class="row g-4">
                ...
                <div class="col-lg-6 col-md-6 col-12 scroll-text-animation" data-animation="fade_from_bottom">
                    <div class="image">
                        <img src="assets/images/project/RaajamGarden (1).png" class="img-fluid gallery-img" alt="Children Play Area">
                    </div>
                </div>
                ...
                <div class="col-lg-6 col-md-6 col-12 scroll-text-animation" data-animation="fade_from_bottom">
                    <div class="image">
                        <img src="assets/images/project/RaajamGarden (4).png" class="img-fluid gallery-img" alt="Car Parking">
                    </div>
                </div>
                <div class="col-lg-6 col-md-6 col-12 scroll-text-animation" data-animation="fade_from_bottom">
                    <div class="image">
                        <img src="assets/images/project/RaajamGarden (5).png" class="img-fluid gallery-img" alt="Car Parking">
                    </div>
                </div>
                  <!-- Image 4 -->
                <div class="col-lg-6 col-md-6 col-12 scroll-text-animation" data-animation="fade_from_bottom">
                    <div class="image">
                        <img src="assets/images/project/RaajamGarden (3).png" class="img-fluid gallery-img" alt="Car Parking">
                    </div>
                </div>
